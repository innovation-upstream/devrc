...
TARGET_FLOORS=(
  ...
  # 2026-09-17, the Stop-hook DECISION EMITTER arrives as a NEW target: 55 collected,
  ...
  #   _suggested_floor 55 = 55 - min(50, max(1, 55/20 = 2)) = 55 - 2 = 53.
  ...
  "scripts/claude-hooks/tests/test_hook_telemetry.py|53"
