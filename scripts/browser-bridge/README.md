...
- **Runtime fail-closed tool-set gate (this is what makes an unverified opencode
  ...
  **Both hosts run 1.18.29** — verified at the consumer 2026-09-08, both
  ...
  the current pin (2026-08-19: the gate replicated ON EACH HOST parses to exactly one
...
is **last verified on 1.18.18** — not re-derived at the current pin, since the check
