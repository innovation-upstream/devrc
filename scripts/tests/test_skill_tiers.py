...
# block fell 7,422 -> 7,242; the control reported 434 chars of slack against a
# 344.9 mean, so leaving it would have banked more than one whole average entry.
# The 254-char headroom is carried across unchanged.
#
