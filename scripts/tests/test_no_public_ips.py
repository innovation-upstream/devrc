...
ALLOWLIST = {
    ...
    ("claudedocs/refs/tmux-webapp-closed-investigations.md", "1.1.1.1"):
        "public resolver, quoted in the docker.io diagnosis as the control that returned a "
        "correct 33s-TTL answer where the router returned a 487-day one. 🔴 REPOINTED "
        "2026-09-18 from claudedocs/handoff-tmux-webapp.md: the diagnosis CLOSED (the pin is "
        "applied and the router's record is normal again) and was demoted verbatim to the "
