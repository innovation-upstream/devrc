...
RULES: list[dict] = [
    ...
    dict(id="prose-hatch-authorship-count", name="the prose hatch's reason is COUNTED from authorship, never before round 2",
         probe="IS AN OBSERVATION ABOUT AUTHORSHIP",
         apply=r"ladder.authored|two.thirds of those findings|authorship determination"),
