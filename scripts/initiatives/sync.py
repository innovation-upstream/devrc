...
def parse_args(argv=None) -> argparse.Namespace:
    ...
    p.add_argument("--days", type=int, default=5,
                   help="trailing window passed to initiative-scan (default 5d — a tight, "
                        "recent board; momentum buckets are absolute last-touch ages, so at 5d "
                        "'cooling'/slowing (2-5d) is the going-quiet triage signal and 'stalled' "
                        "(≥7d) is empty; widen for deep-stalled work)")
