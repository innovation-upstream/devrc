 ...
 *
 * Examples:
 *   @[alex]          → fuzzy matches "Alex Rivera" (user 90000002)
 *   @[90000002]      → direct user ID
 *   @[jane@co.com]   → matches by email
 *   @Alex Rivera     → bare match against workspace members
 *   @Alex            → bare partial match (first name only)
 */
 ...
 * Tries longest match first (e.g. "@Alex Rivera" before "@Alex").
