...
echo "    expected: localsearch-3.service present (it IS the file indexer), plus"
echo "              localsearch-control-3, localsearch-writeback-3, tinysparql-xdg-portal-3,"
echo "              and NO tracker-* units at all. THAT LAST CLAUSE IS THE REAL TEST."
echo "    🔴 There is NO tinysparql-miner-fs-3.service — do not go looking for one."
echo "       An earlier version of this line said to expect it, which reads as"
echo "       'the rename broke' when nothing is wrong. MEASURED 2026-09-09 on the"
echo "       real post-switch system: the indexer moved INTO localsearch"
echo "       (localsearch-3.11.1 ships localsearch-3/-control-3/-writeback-3);"
echo "       tinysparql ships only tinysparql-xdg-portal-3. Four units, no miner."
