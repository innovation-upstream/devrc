...
with pkgs; [
  ...
  # /nix/store/6pw7n475sa1d4scq8sy1qkdn2bcy0glc-opencode-1.18.29, which is also
  # what `readlink -f $(command -v opencode)` resolves to on BOTH hosts. (It was
