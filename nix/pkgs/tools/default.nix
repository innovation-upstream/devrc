...
with pkgs; [
  ...
  #
  # This entry pins them: MEASURED at flake.lock's nixpkgs rev 42f17a57f4f6,
  # `pkgs.opencode` is 1.18.29 — store path
  # /nix/store/6pw7n475sa1d4scq8sy1qkdn2bcy0glc-opencode-1.18.29. (It was
  # 1.18.4 at rev 9bc02893134c when this pin was introduced, and 1.18.16 at rev
  # 044bfe75bfe4; the 2026-08-13, 2026-08-19, 2026-08-29 and 2026-09-08 bumps
  # each re-derived the claims against the new binary rather than re-spelling
  # them — see PINNED_VERSION in scripts/tests/test_opencode_engine.py.)
  # A nixpkgs bump
