...
map('n', '<leader>hd', 'o<div className=""><CR></div><Esc>O')
map('n', '<leader>hb', 'o<button className=""><CR></button><Esc>O')
map('n', '<leader>hl', 'o<label className=""><CR></label><Esc>O')
map('n', '<leader>hs', 'o<span className=""><CR></span><Esc>O')
map('n', '<leader>hf', 'o<div className="flex "><CR></div><Esc>O')
map('n', '<C-j>', '4j')
map('n', '<C-k>', '4k')
map('n', '<C-b>', '_')
map('v', '<C-j>', '4j')
